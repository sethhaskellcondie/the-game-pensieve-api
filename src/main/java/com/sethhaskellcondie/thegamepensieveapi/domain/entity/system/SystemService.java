...
@Service
public class SystemService extends EntityServiceAbstract<System, SystemRequestDto, SystemResponseDto, SystemRepository>
        implements EntityService<System, SystemRequestDto, SystemResponseDto> {
